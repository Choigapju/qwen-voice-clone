...
- 📝 **목소리 복제**: 원본 음성의 목소리 특징을 완벽하게 따라하여 새로운 대사 생성
...
### Voice Clone 사용 팁!
Qwen 모델이 원본 목소리를 제대로 분석하기 위해서는, 사용된 오디오의 **실제 대사**를 알려주어야 합니다. UI의 **Reference Text** 입력란에, 업로드하신 음성의 *처음 5초 분량*에 해당하는 실제 대본을 꼭 입력해 주세요.
